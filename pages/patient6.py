...
medcsv = pd.read_csv('mimicData/P6/inputText21161964.csv')
# uniikit lääkenimet valintaa varten
medoptions = sorted(medcsv["label"].unique())
# charted event taulukko
charcsv = pd.read_csv('mimicData/P6/Responce21161964.csv')
...
# diagnoosit taulukko
diagcsv = pd.read_csv('mimicData/P6/patient21161964_descDiag.csv')
...
# Medication graph
@callback(
    Output("medication6", "figure"),
    [Input("medChecklist6", "value")])
...
@callback(
    Output("chartedevents6", "figure"),
    [Input("charChecklist6", "value")])
