...
medcsv = pd.read_csv('mimicData/P9/inputText28816463.csv')
# uniikit lääkenimet valintaa varten
medoptions = sorted(medcsv["label"].unique())
# charted event taulukko
charcsv = pd.read_csv('mimicData/P9/Responce28816463.csv')
...
# diagnoosit taulukko
diagcsv = pd.read_csv('mimicData/P9/patient28816463_descDiag.csv')
...
# Medication graph
@callback(
    Output("medication9", "figure"),
    [Input("medChecklist9", "value")])
...
@callback(
    Output("chartedevents9", "figure"),
    [Input("charChecklist9", "value")])
