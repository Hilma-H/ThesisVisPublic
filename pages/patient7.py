...
medcsv = pd.read_csv('mimicData/P7/inputText21955132.csv')
# uniikit lääkenimet valintaa varten
medoptions = sorted(medcsv["label"].unique())
# charted event taulukko
charcsv = pd.read_csv('mimicData/P7/Responce21955132.csv')
...
# diagnoosit taulukko
diagcsv = pd.read_csv('mimicData/P7/patient21955132_descDiag.csv')
...
# Medication graph
@callback(
    Output("medication7", "figure"),
    [Input("medChecklist7", "value")])
...
@callback(
    Output("chartedevents7", "figure"),
    [Input("charChecklist7", "value")])
