...
medcsv = pd.read_csv('mimicData/P10/inputText29336897.csv')
# uniikit lääkenimet valintaa varten
medoptions = sorted(medcsv["label"].unique())
# charted event taulukko
charcsv = pd.read_csv('mimicData/P10/Responce29336897.csv')
...
# diagnoosit taulukko
diagcsv = pd.read_csv('mimicData/P10/patient29336897_descDiag.csv')
...
# Medication graph
@callback(
    Output("medication10", "figure"),
    [Input("medChecklist10", "value")])
...
@callback(
    Output("chartedevents10", "figure"),
    [Input("charChecklist10", "value")])
